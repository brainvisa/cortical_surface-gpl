...
insert( '{center}/{subject}/t1mri/{acquisition}/{analysis}/segmentation/mesh',
  'surface_analysis', SetContent(
    ...
    '<subject>_Lwhite_spherical', SetType( 'Left hemisphere spherical mesh' ), SetWeakAttr( 'side', 'left' ),
    '<subject>_Rwhite_spherical', SetType( 'Right hemisphere spherical mesh' ), SetWeakAttr( 'side', 'right' ),
