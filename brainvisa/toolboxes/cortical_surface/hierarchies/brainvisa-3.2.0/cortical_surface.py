...
insert( '{center}/{subject}',
  'surface', SetContent(
    ...
    '<subject>_Lwhite_insula', SetType( 'Left insula pole texture' ), SetWeakAttr( 'side', 'left' ),
    '<subject>_Rwhite_insula', SetType( 'Right insula pole texture' ), SetWeakAttr( 'side', 'right' ),
    '<subject>_Lwhite_hippo', SetType( 'Left hippocampus pole texture' ), SetWeakAttr( 'side', 'left' ),
    '<subject>_Rwhite_hippo', SetType( 'Right hippocampus pole texture' ), SetWeakAttr( 'side', 'right' ),
    ...
    '<subject>_Lwhite_gyri', SetType( 'Left hemisphere gyri parcellation texture'), SetWeakAttr( 'side', 'left' ),
    '<subject>_Rwhite_gyri', SetType( 'Right hemisphere gyri parcellation texture'), SetWeakAttr( 'side', 'right' ),
    '<subject>_Lwhite_gyri_regul', SetType( 'Left hemisphere regularized parcellation texture'), SetWeakAttr( 'side', 'left' ),
    '<subject>_Rwhite_gyri_regul', SetType( 'Right hemisphere regularized parcellation texture'), SetWeakAttr( 'side', 'right' ),
