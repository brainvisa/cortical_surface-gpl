...
insert( '{protocol}/{subject}',
  'surface', SetContent(
    ...
    #'<subject>_Lhippo_Volume', SetType( 'Left Cingular Pole Template' ), SetWeakAttr( 'side', 'left' ),
    #'<subject>_Rhippo_Volume', SetType( 'Right Cingular Pole Template' ), SetWeakAttr( 'side', 'right' ),
